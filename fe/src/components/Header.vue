...
<template>
  <div class="header">
    <div class="header-box container">
      ...
      <div class="tenten">
        <router-link to="/"> Truyentranh.org </router-link>
      </div>
      <input
        type="text"
        class="search-input"
        placeholder="Tìm kiếm"
        v-model="bookStore.searchTitle"
      />
      <div>
        <div class="dropdown" v-if="!user.token">
          ...
          <ul class="dropdown-menu" aria-labelledby="login-btn">
            ...
            <li>
              <router-link class="dropdown-item" to="/loginmanager"
...
.header {
  ...
  .header-box {
    ...
    .search-input {
      width: 300px;
      margin-left: 10px;
      border: 2px solid  rgba(224, 35, 158, 0.316);
      border-radius: 4px;
      padding: 4px 8px;
      ...
      &:focus {
        ...
        box-shadow: rgba(0, 224, 255, 0.1) 0px 6px 12px -2px,
          rgba(0, 224, 255, 0.1) 0px 3px 7px -3px;
      }
    }
    .menu-icon {
      font-size: 26px;
